...
tDFUI_translation["enUS"] = {
  ...
  ["Adds a remaining cast time to the cast bar."] = nil,
  ...
  ["Bar Layout"] = nil,
  ["barlayout_desc"] = "Reshape your action bars: how many buttons they show, how many fit per row, and whether they run across or down. Adjust it from the Bar shape section of Edit Mode.",
  ["Edit Mode"] = nil,
  ["editmode_desc"] = "Edit your tDF layout!",
